...
import { validateJobName, validateXmlConfig, validateBuildParameters } from './validation.js';
    ...
    try {
        ...
        switch (name) {
            ...
            case 'get_build_log': {
                ...
                const log = await jenkinsClient.getBuildLog(params.jobName, params.buildNumber, params.start);
                return {
                    content: [{
                            type: 'text',
                            text: log
            ...
            case 'download_artifact': {
                ...
                const data = await jenkinsClient.downloadArtifact(params.jobName, params.buildNumber, params.artifactPath);
                return {
                    content: [{
                            type: 'text',
